...
you can use the [@sytechui/use-theme](https://github.com/heroui-inc/heroui/tree/canary/packages/hooks/use-theme) hook to switch between themes.

<Steps> 

### Install @sytechui/use-theme

Install `@sytechui/use-theme` in your project.

<PackageManagers
  commands={{
    npm: 'npm install @sytechui/use-theme',
    yarn: 'yarn add @sytechui/use-theme',
    pnpm: 'pnpm add @sytechui/use-theme',
  }}
/> 
