...
Or you can add the main library `@sytechui/react` by running the following command:
...
<PackageManagers
  commands={{
    npm: "npm install @sytechui/react framer-motion",
    yarn: "yarn add @sytechui/react framer-motion",
    pnpm: "pnpm add @sytechui/react framer-motion",
    bun: "bun add @sytechui/react framer-motion"
  }}
/>
...
```ts
// hero.ts
import { heroui } from "@sytechui/react";
...
@source '../../node_modules/@sytechui/theme/dist/**/*.{js,ts,jsx,tsx}';
...
<PackageManagers
  commands={{
    npm: "npm install @sytechui/theme @sytechui/system framer-motion",
    yarn: "yarn add @sytechui/theme @sytechui/system framer-motion",
    pnpm: "pnpm add @sytechui/theme @sytechui/system framer-motion",
    bun: "bun add @sytechui/theme @sytechui/system framer-motion"
  }}
/>
...
<PackageManagers
  commands={{
    npm: "npm install @sytechui/button",
    yarn: "yarn add @sytechui/button",
    pnpm: "pnpm add @sytechui/button",
    bun: "bun add @sytechui/button"
  }}
/>
...
```js
// tailwind.config.js
const {heroui} = require("@sytechui/theme");

/** @type {import('tailwindcss').Config} */
module.exports = {
  content: [
    // single component styles
    "./node_modules/@sytechui/theme/dist/components/button.js",
    // or you can use a glob pattern (multiple component styles)
    './node_modules/@sytechui/theme/dist/components/(button|snippet|code|input).js'
  ],
  theme: {
    extend: {},
  },
