...
<PackageManagers
  commands={{
    npm: "npx @sytechui/codemod@latest migrate",
    pnpm: "pnpm dlx @sytechui/codemod@latest migrate",
    yarn: "yarn dlx @sytechui/codemod@latest migrate",
    bun: "bunx --bun @sytechui/codemod@latest migrate"
  }}
/>
...
- Update all package names from `@nextui-org/*` to `@sytechui/*`
...
<PackageManagers
  commands={{
    npm: "npm uninstall @nextui-org/react && npm install @sytechui/react",
    yarn: "yarn remove @nextui-org/react && yarn add @sytechui/react",
    pnpm: "pnpm remove @nextui-org/react && pnpm add @sytechui/react",
    bun: "bun remove @nextui-org/react && bun add @sytechui/react"
  }}
/>
...
// After
const {heroui} = require("@sytechui/react");
...
// After
import {Button, Input} from "@sytechui/react";
```
...
import {heroui} from "@sytechui/theme";
import {HeroUIProvider} from "@sytechui/react";
```
