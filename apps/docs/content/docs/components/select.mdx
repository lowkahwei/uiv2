...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @sytechui/select",
    yarn: "yarn add @sytechui/select",
    pnpm: "pnpm add @sytechui/select",
    bun: "bun add @sytechui/select"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Select, SelectSection, SelectItem} from "@sytechui/react";',
    individual: 'import {Select, SelectSection, SelectItem} from "@sytechui/select";',
  }}
/>
...
<PackageManagers
  commands={{
    npm: "npm install @sytechui/use-infinite-scroll",
    yarn: "yarn add @sytechui/use-infinite-scroll",
    pnpm: "pnpm add @sytechui/use-infinite-scroll",
  }}
/>
