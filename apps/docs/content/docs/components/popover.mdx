...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @sytechui/popover",
    yarn: "yarn add @sytechui/popover",
    pnpm: "pnpm add @sytechui/popover",
    bun: "bun add @sytechui/popover"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Popover, PopoverTrigger, PopoverContent} from "@sytechui/react";',
    individual: 'import {Popover, PopoverTrigger, PopoverContent} from "@sytechui/popover";',
  }}
/>
