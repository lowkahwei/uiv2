...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @sytechui/spinner",
    yarn: "yarn add @sytechui/spinner",
    pnpm: "pnpm add @sytechui/spinner",
    bun: "bun add @sytechui/spinner"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Spinner} from "@sytechui/react";',
    individual: 'import {Spinner} from "@sytechui/spinner";',
  }}
/>
