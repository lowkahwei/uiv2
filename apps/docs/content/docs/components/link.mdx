...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @sytechui/link",
    yarn: "yarn add @sytechui/link",
    pnpm: "pnpm add @sytechui/link",
    bun: "bun add @sytechui/link"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Link} from "@sytechui/react";',
    individual: 'import {Link} from "@sytechui/link";',
  }}
/>
