...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @sytechui/accordion",
    yarn: "yarn add @sytechui/accordion",
    pnpm: "pnpm add @sytechui/accordion",
    bun: "bun add @sytechui/accordion"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Accordion, AccordionItem} from "@sytechui/react";',
    individual: 'import {Accordion, AccordionItem} from "@sytechui/accordion";',
  }}
/>
