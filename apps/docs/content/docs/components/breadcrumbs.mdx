...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @sytechui/breadcrumbs",
    yarn: "yarn add @sytechui/breadcrumbs",
    pnpm: "pnpm add @sytechui/breadcrumbs",
    bun: "bun add @sytechui/breadcrumbs"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Breadcrumbs, BreadcrumbItem} from "@sytechui/react";',
    individual: 'import {Breadcrumbs, BreadcrumbItem} from "@sytechui/breadcrumbs";',
  }}
/>
