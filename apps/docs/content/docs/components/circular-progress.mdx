...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @sytechui/progress",
    yarn: "yarn add @sytechui/progress",
    pnpm: "pnpm add @sytechui/progress",
    bun: "bun add @sytechui/progress"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {CircularProgress} from "@sytechui/react";',
    individual: 'import {CircularProgress} from "@sytechui/progress";',
  }}
/>
