...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @sytechui/checkbox",
    yarn: "yarn add @sytechui/checkbox",
    pnpm: "pnpm add @sytechui/checkbox",
    bun: "bun add @sytechui/checkbox"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {CheckboxGroup, Checkbox} from "@sytechui/react";',
    individual: 'import {CheckboxGroup, Checkbox} from "@sytechui/checkbox";',
  }}
/>
