...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @sytechui/calendar",
    yarn: "yarn add @sytechui/calendar",
    pnpm: "pnpm add @sytechui/calendar",
    bun: "bun add @sytechui/calendar",
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {RangeCalendar} from "@sytechui/react";',
    individual: 'import {RangeCalendar} from "@sytechui/calendar";',
  }}
/>
