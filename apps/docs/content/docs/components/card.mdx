...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @sytechui/card",
    yarn: "yarn add @sytechui/card",
    pnpm: "pnpm add @sytechui/card",
    bun: "bun add @sytechui/card"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Card, CardHeader, CardBody, CardFooter} from "@sytechui/react";',
    individual: 'import {Card, CardHeader, CardBody, CardFooter} from "@sytechui/card";',
  }}
/>
