...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @sytechui/dropdown",
    yarn: "yarn add @sytechui/dropdown",
    pnpm: "pnpm add @sytechui/dropdown",
    bun: "bun add @sytechui/dropdown"
  }}
/>
...
```jsx
import {Dropdown, DropdownMenu, DropdownTrigger, DropdownItem, Button} from "@sytechui/react";
