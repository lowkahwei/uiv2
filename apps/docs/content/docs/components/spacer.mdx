...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @sytechui/spacer",
    yarn: "yarn add @sytechui/spacer",
    pnpm: "pnpm add @sytechui/spacer",
    bun: "bun add @sytechui/spacer"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Spacer} from "@sytechui/react";',
    individual: 'import {Spacer} from "@sytechui/spacer";',
  }}
/>
