...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @sytechui/user",
    yarn: "yarn add @sytechui/user",
    pnpm: "pnpm add @sytechui/user",
    bun: "bun add @sytechui/user"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {User} from "@sytechui/react";',
    individual: 'import {User} from "@sytechui/user";',
  }}
/>
