...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @sytechui/form",
    yarn: "yarn add @sytechui/form",
    pnpm: "pnpm add @sytechui/form",
    bun: "bun add @sytechui/form",
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Form} from "@sytechui/react";',
    individual: 'import {Form} from "@sytechui/form";',
  }}
/>
...
```tsx
import {Form, Button} from '@sytechui/react';
