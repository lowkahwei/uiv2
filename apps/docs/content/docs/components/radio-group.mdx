...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @sytechui/radio",
    yarn: "yarn add @sytechui/radio",
    pnpm: "pnpm add @sytechui/radio",
    bun: "bun add @sytechui/radio"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {RadioGroup, Radio} from "@sytechui/react";',
    individual: 'import {RadioGroup, Radio} from "@sytechui/radio";',
  }}
/>
