...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @sytechui/autocomplete",
    yarn: "yarn add @sytechui/autocomplete",
    pnpm: "pnpm add @sytechui/autocomplete",
    bun: "bun add @sytechui/autocomplete",
  }}
/>
