...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @sytechui/avatar",
    yarn: "yarn add @sytechui/avatar",
    pnpm: "pnpm add @sytechui/avatar",
    bun: "bun add @sytechui/avatar"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Avatar, AvatarGroup, AvatarIcon} from "@sytechui/react";',
    individual: 'import {Avatar, AvatarGroup, AvatarIcon} from "@sytechui/avatar";',
  }}
/>
