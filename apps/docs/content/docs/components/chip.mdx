...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @sytechui/chip",
    yarn: "yarn add @sytechui/chip",
    pnpm: "pnpm add @sytechui/chip",
    bun: "bun add @sytechui/chip"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Chip} from "@sytechui/react";',
    individual: 'import {Chip} from "@sytechui/chip";',
  }}
/>
