...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @sytechui/snippet",
    yarn: "yarn add @sytechui/snippet",
    pnpm: "pnpm add @sytechui/snippet",
    bun: "bun add @sytechui/snippet"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Snippet} from "@sytechui/react";',
    individual: 'import {Snippet} from "@sytechui/snippet";',
  }}
/>
