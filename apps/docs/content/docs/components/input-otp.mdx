...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @sytechui/input-otp",
    yarn: "yarn add @sytechui/input-otp",
    pnpm: "pnpm add @sytechui/input-otp",
    bun: "bun add @sytechui/input-otp",
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {InputOtp} from "@sytechui/react";',
    individual: 'import {InputOtp} from "@sytechui/input-otp";',
  }}
/>
