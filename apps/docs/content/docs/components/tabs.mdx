...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @sytechui/tabs",
    yarn: "yarn add @sytechui/tabs",
    pnpm: "pnpm add @sytechui/tabs",
    bun: "bun add @sytechui/tabs"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Tabs, Tab} from "@sytechui/react";',
    individual: 'import {Tabs, Tab} from "@sytechui/tabs";',
  }}
/>
