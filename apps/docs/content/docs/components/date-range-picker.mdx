...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @sytechui/date-picker",
    yarn: "yarn add @sytechui/date-picker",
    pnpm: "pnpm add @sytechui/date-picker",
    bun: "bun add @sytechui/date-picker",
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {DateRangePicker} from "@sytechui/react";',
    individual: 'import {DateRangePicker} from "@sytechui/date-picker";',
  }}
/>
