...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @sytechui/skeleton",
    yarn: "yarn add @sytechui/skeleton",
    pnpm: "pnpm add @sytechui/skeleton",
    bun: "bun add @sytechui/skeleton"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Skeleton} from "@sytechui/react";',
    individual: 'import {Skeleton} from "@sytechui/skeleton";',
  }}
/>
