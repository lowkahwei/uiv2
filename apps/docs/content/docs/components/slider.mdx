...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @sytechui/slider",
    yarn: "yarn add @sytechui/slider",
    pnpm: "pnpm add @sytechui/slider",
    bun: "bun add @sytechui/slider"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Slider} from "@sytechui/react";',
    individual: 'import {Slider} from "@sytechui/slider";',
  }}
/>
