...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @sytechui/pagination",
    yarn: "yarn add @sytechui/pagination",
    pnpm: "pnpm add @sytechui/pagination",
    bun: "bun add @sytechui/pagination"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Pagination, PaginationItem, PaginationCursor} from "@sytechui/react";',
    individual:
      'import {Pagination, PaginationItem, PaginationCursor} from "@sytechui/pagination";',
  }}
/>
