...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @sytechui/date-input",
    yarn: "yarn add @sytechui/date-input",
    pnpm: "pnpm add @sytechui/date-input",
    bun: "bun add @sytechui/date-input"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {TimeInput} from "@sytechui/react";',
    individual: 'import {TimeInput} from "@sytechui/date-input";',
  }}
/>
