...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @sytechui/scroll-shadow",
    yarn: "yarn add @sytechui/scroll-shadow",
    pnpm: "pnpm add @sytechui/scroll-shadow",
    bun: "bun add @sytechui/scroll-shadow"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {ScrollShadow} from "@sytechui/react";',
    individual: 'import {ScrollShadow} from "@sytechui/scroll-shadow";',
  }}
/>
