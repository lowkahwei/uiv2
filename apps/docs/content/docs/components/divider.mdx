...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @sytechui/divider",
    yarn: "yarn add @sytechui/divider",
    pnpm: "pnpm add @sytechui/divider",
    bun: "bun add @sytechui/divider"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Divider} from "@sytechui/react";',
    individual: 'import {Divider} from "@sytechui/divider";',
  }}
/>
