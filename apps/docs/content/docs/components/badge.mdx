...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @sytechui/badge",
    yarn: "yarn add @sytechui/badge",
    pnpm: "pnpm add @sytechui/badge",
    bun: "bun add @sytechui/badge"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Badge} from "@sytechui/react";',
    individual: 'import {Badge} from "@sytechui/badge";',
  }}
/>
