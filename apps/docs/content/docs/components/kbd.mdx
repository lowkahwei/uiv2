...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @sytechui/kbd",
    yarn: "yarn add @sytechui/kbd",
    pnpm: "pnpm add @sytechui/kbd",
    bun: "bun add @sytechui/kbd"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Kbd} from "@sytechui/react";',
    individual: 'import {Kbd} from "@sytechui/kbd";',
  }}
/>
