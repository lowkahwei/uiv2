...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @sytechui/switch",
    yarn: "yarn add @sytechui/switch",
    pnpm: "pnpm add @sytechui/switch",
    bun: "bun add @sytechui/switch"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Switch} from "@sytechui/react";',
    individual: 'import {Switch} from "@sytechui/switch";',
  }}
/>
