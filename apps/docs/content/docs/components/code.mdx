...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @sytechui/code",
    yarn: "yarn add @sytechui/code",
    pnpm: "pnpm add @sytechui/code",
    bun: "bun add @sytechui/code"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Code} from "@sytechui/react";',
    individual: 'import {Code} from "@sytechui/code";',
  }}
/>
