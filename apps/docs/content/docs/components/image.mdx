...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @sytechui/image",
    yarn: "yarn add @sytechui/image",
    pnpm: "pnpm add @sytechui/image",
    bun: "bun add @sytechui/image"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Image} from "@sytechui/react";',
    individual: 'import {Image} from "@sytechui/image";',
  }}
/>
