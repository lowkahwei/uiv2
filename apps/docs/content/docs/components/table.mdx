...
```jsx
import {Table, TableHeader, TableColumn, TableBody, TableRow, TableCell, getKeyValue} from "@sytechui/react";
...
[@sytechui/use-infinite-scroll](https://www.npmjs.com/package/@sytechui/use-infinite-scroll) hook.

<PackageManagers
  commands={{
    npm: "npm install @react-stately/data @sytechui/use-infinite-scroll",
    yarn: "yarn add @react-stately/data @sytechui/use-infinite-scroll",
    pnpm: "pnpm add @react-stately/data @sytechui/use-infinite-scroll",
    bun: "bun add @react-stately/data @sytechui/use-infinite-scroll",
  }}
/>
