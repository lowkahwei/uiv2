...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @sytechui/tooltip",
    yarn: "yarn add @sytechui/tooltip",
    pnpm: "pnpm add @sytechui/tooltip",
    bun: "bun add @sytechui/tooltip"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Tooltip} from "@sytechui/react";',
    individual: 'import {Tooltip} from "@sytechui/tooltip";',
  }}
/>

> For individual installation, please note that you should add `./node_modules/@sytechui/theme/dist/components/popover.js` to your `tailwind.config.js` file instead since tooltip reuses popover styles.
