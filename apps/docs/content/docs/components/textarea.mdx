...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @sytechui/input",
    yarn: "yarn add @sytechui/input",
    pnpm: "pnpm add @sytechui/input",
    bun: "bun add @sytechui/input",
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Textarea} from "@sytechui/react";',
    individual: 'import {Textarea} from "@sytechui/input";',
  }}
/>
