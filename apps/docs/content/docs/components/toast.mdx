...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @sytechui/toast",
    yarn: "yarn add @sytechui/toast",
    pnpm: "pnpm add @sytechui/toast",
    bun: "bun add @sytechui/toast",
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {addToast, ToastProvider} from "@sytechui/react";',
    individual: 'import {addToast, ToastProvider} from "@sytechui/toast";',
  }}
/>
