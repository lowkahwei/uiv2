...
<PackageManagers
  commands={{
    npm: "npm install @sytechui/react@latest framer-motion@latest",
    pnpm: "pnpm add @sytechui/react@latest framer-motion@latest",
    yarn: "yarn add @sytechui/react@latest framer-motion@latest",
    bun: "bun add @sytechui/react@latest framer-motion@latest",
  }}
/>
...
```diff-tsx
// Before
- "./node_modules/@sytechui/theme/dist/components/circular-progress.js";

// After
+ "./node_modules/@sytechui/theme/dist/components/progress.js";
```
