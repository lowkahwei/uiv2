...
<PackageManagers
  commands={{
    npm: "npm install @sytechui/react@latest",
    pnpm: "pnpm add @sytechui/react@latest",
    yarn: "yarn add @sytechui/react@latest",
    bun: "bun add @sytechui/react@latest",
  }}
/>
...
```tsx
// app/providers.tsx
import {HeroUIProvider, ToastProvider} from '@sytechui/react'
// for individual components use the following import
// import {ToastProvider} from '@sytechui/toast'
...
```tsx
import {Button, addToast} from "@sytechui/react";
...
```tsx
import {Table} from "@sytechui/react";
...
```tsx
import type {PressEvent} from "@sytechui/react";
