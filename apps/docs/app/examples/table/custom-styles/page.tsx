...
import type {Selection, ChipProps, SortDescriptor} from "@sytechui/react";
...
import {ChevronDownIcon, SearchIcon} from "@sytechui/shared-icons";
    ...
    <div className="p-6">
      <Table isCompact removeWrapper classNames={classNames}>
        ...
        >
          ...
          <TableBody renderEmptyState={() => "No users found"} items={sortedItems}>
            {(item) => (
              <TableRow columns={headerColumns} id={item.id}>
